...
class change_ppt_slide_text_font_size(BaseAction):
    def __init__(self):
        self._description = "Change the font size of the title or body text in a specified slide of a PowerPoint file."

    def __call__(self, ppt_path, slide_index, text_type, font_size):
        """
...
# Example usage
# res = change_ppt_slide_text_font_size("path/to/your/presentation.pptx", 0, 'title', 24)  # Change title font size to 24
# print(res)