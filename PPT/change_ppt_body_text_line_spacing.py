...
class change_ppt_body_text_line_spacing(BaseAction):
    def __init__(self):
        self._description = "Change the line spacing of the body text in a specified slide of a PowerPoint file."

    def __call__(self, ppt_path, slide_index, line_spacing):
        """
...
# Example usage
# change_ppt_body_text_line_spacing()("path/to/your/presentation.pptx", 0, 1.5)  # Set 1.5x line spacing
# change_ppt_body_text_line_spacing()("path/to/your/presentation.pptx", 1, Pt(18))  # Set 18pt line spacing
