...
class change_ppt_slide_text_color(BaseAction):
    def __init__(self):
        self._description = "Change the color of the title or body text in a specified slide of a PowerPoint file."

    def __call__(self, ppt_path, slide_index, text_type, color):
        """
...
# Example usage
# res = change_ppt_slide_text_color()("path/to/your/presentation.pptx", 0, 'body', (255, 0, 0))  # Change title to red
# print(res)
