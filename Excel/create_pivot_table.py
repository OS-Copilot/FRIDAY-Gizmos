...
class create_pivot_table(BaseAction):
    def __init__(self):
        self._description = "Creates a simulated pivot table in an Excel file using openpyxl and pandas."

    def __call__(self, excel_path, source_sheet, target_sheet, row_labels, col_labels, aggfunc):
        """
...
# Example usage
# print(create_pivot_table()('./PricingTable.xlsx', 'Sheet1', 'Sheet2', ['Day'], ['Number of Rolls'], 'mean'))
